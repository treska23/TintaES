...
{
    private const string CurrentUiBuildStamp = "UI 2026.07.31-r33";
    ...
    private void InstallCurrentUiBootstrap()
    {
        ...
        FontCategoryComboBox.ToolTip = "TintaES utiliza una única tipografía de manga para todos los bocadillos";
